...
if [ $SkipImport = 0 ]; then
  ...
  for file_base_name in gen_cap trans_cap local_td_cap generator_and_storage_dispatch transmission_dispatch system_load existing_trans_cost_and_rps_reduced_cost
  do

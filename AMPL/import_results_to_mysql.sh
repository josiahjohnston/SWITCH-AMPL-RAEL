...
#  mysql $connection_string --column-names=false -e "call clear_scenario_results(${SCENARIO_ID});"
  ...
  for file_base_name in gen_cap trans_cap local_td_cap transmission_dispatch system_load existing_trans_cost rps_reduced_cost generator_and_storage_dispatch load_wind_solar_operating_reserve_levels consume_and_redirect_variables
  do
